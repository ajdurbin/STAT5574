...
```{r, echo = FALSE, fig.align='center', fig.cap='Weighting functions for Huber and  Tukey estimation procedures.', fig.width=5, fig.height=4}

knitr::include_graphics("Weight.png")

```

Note that Tukey's Biweight only gives full weight to observations with zero residual, that is observations directly on the regression line. It then down-weights observations more severely than the Hubert criteria. Note that Hubert estimation gives observations *near* the regression line full weight.
