...
This was my first experience with sampling statistics and an introduction to the `survey` package in `R`. We predominately used the regression and logistic regression model functions built in. An example is the following: DATA AND REG
...
```{r eval = TRUE, echo = FALSE, fig.width=6, fig.height=3.4, fig.align='center'}
  p <- draw.triple.venn(214, 198, 32, 43, 19, 0, 0, c('Sample 1', 'Sample 2', 'Sample 3'), fill = c("blue", "red", "green"))
```

<!-- dat <- -->
<!--   read.table( text = -->
<!--                 "id str clu wt a b c d e -->
<!-- 		1 1 1 4 4213 2867 28618 -24014 .25 -->
<!-- 		2 1 4 4 706 2867 4896 -2029 .25 -->
<!-- 		3 1 5 4 712 2867 3730 -863 .25 -->
<!-- 		4 1 15 4 124 2867 556 2311 .25 -->
<!-- 		5 1 18 4 178 2867 1463 1404 .25 -->
<!-- 		6 1 26 4 313 2867 1946 921 .25 -->
<!-- 		7 1 30 4 172 2867 834 2033 .25 -->
<!-- 		8 1 31 4 291 2867 932 1935 .25 -->
<!--     9 1 38 4 651 2867 1147 1720 .25 -->
<!--     10 1 47 4 1206 2857 3089 -222 .25", -->
<!--     header = TRUE -->
<!--   ) -->
...
<!--     fpc = ~fpc -->
<!--   ) -->
<!-- my_glm <- svyglm(a ~ c, my_design) -->
<!-- summary(my_glm) -->

<!-- pred.df <- data.frame(c = sum(dat$wt) * 2867) -->
